Vagrant.configure("2") do |config|
  config.vm.define "sensuapp" do |sensuapp|
	...
	sensuapp.vm.provision "shell", path: "https://raw.githubusercontent.com/davetayl/Vagrant-General/master/setup-centos8-nu.sh"
  ...
  config.vm.define "influxdb" do |influxdb|
	...
	influxdb.vm.provision "shell", path: "https://raw.githubusercontent.com/davetayl/Vagrant-General/master/setup-centos8-nu.sh"
  ...
  config.vm.define "agent1" do |agent1|
	...
	agent1.vm.provision "shell", path: "https://raw.githubusercontent.com/davetayl/Vagrant-General/master/setup-centos8-nu.sh"
  ...
  config.vm.define "agent2" do |agent2|
	...
	agent2.vm.provision "shell", path: "https://raw.githubusercontent.com/davetayl/Vagrant-General/master/setup-centos8-nu.sh"
