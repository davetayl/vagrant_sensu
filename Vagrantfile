Vagrant.configure("2") do |config|
  config.vm.define "sensuapp" do |sensuapp|
	...
	sensuapp.vm.provision "shell", path: "https://github.com/davetayl/Vagrant-General/raw/master/setup-centos8.sh"
  ...
  config.vm.define "agent" do |agent|
	...
	agent.vm.provision "shell", path: "https://github.com/davetayl/Vagrant-General/raw/master/setup-centos7.sh"
